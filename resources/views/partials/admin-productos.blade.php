        ...
        <table class="table mb-0 small align-middle">
            ...
            <tbody>
                ...
                <tr style="border-top:1px solid var(--border-color);" id="fila-{{ $producto->id }}">
                    <td class="p-3">
                        <img src="{{ asset($producto->imagen) }}" alt="{{ $producto->nombre }}" class="rounded-2 object-fit-contain" style="width:56px;height:56px;">
                    </td>
                    ...
                    <td class="p-3 text-center">
                        <div class="d-flex gap-2 justify-content-center">
                            ...
                            <form method="POST" action="{{ route('moderador.destroy', $producto->id) }}" onsubmit="return confirm('¿Eliminar este producto?')">
                                @csrf @method('DELETE')
